...
def generate_launch_description():
    ...
    survey_camera_bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        name='survey_camera_bridge',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
        arguments=[
            ['/world/', world,
             '/model/survey_camera/link/camera_link/sensor/survey_rgb/image' +
             '@sensor_msgs/msg/Image' +
             '[gz.msgs.Image'],
            ['/world/', world,
             '/model/survey_camera/link/camera_link/sensor/survey_rgb/camera_info' +
             '@sensor_msgs/msg/CameraInfo' +
             '[gz.msgs.CameraInfo'],
        ],
        remappings=[
    ...
    ld.add_action(survey_camera_bridge)
    return ld
